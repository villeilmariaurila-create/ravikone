...
# ==============================================================================
# 2. DATA (LÄHDÖT 1-12 MUKAAN LUKIEN MATS DJUSEN VIHJEET)
# ==============================================================================
...
DATABANK = {
    ...
    5: {
        ...
        "matka": "2140m Autostart",
        "tyyppi": "2140a",
        "vihje": "<b>Mats Djuse:</b> 9 Night Hawk on avoimen lähdön ensihevonen. Huomioi myös 2 Hip To Be Square ja vaarallinen 1 T.Wall's Notorius.<br><b>Daniel Berglund:</b> 9 Night Hawk ja 2 Hip To Be Square vahvoilla.<br><b>Jens Sjödén:</b> 10/11 kertaa voittaja löytynyt 2 suosituimman joukosta.",
        "hevoset": [
    ...
    6: {
        ...
        "matka": "2140m Voltstart",
        "tyyppi": "tasoitus",
        "vihje": "<b>Mats Djuse:</b> 4 Silke Sjarmör on norjalaisvierailijana mielenkiintoinen. Ajokki 5 Ellbert omaa hyvän päivänkunnon.<br><b>Daniel Berglund:</b> Sekava lähtö. 8 Teknologen paras takaa, paalu vahva.<br><b>Jens Sjödén:</b> Syksyllä takaa tullaan paremmin läpi (21% voitoista).",
        "hevoset": [
    ...
    7: {
        ...
        "matka": "1640m Autostart",
        "tyyppi": "guld",
        "vihje": "<b>Mats Djuse:</b> 4 Mizai voi yllättää keulasta. Ajokki 6 Mellby Joker hakee hyvää sijoitusta.<br><b>Daniel Berglund:</b> Vain 7 hevosta, taktinen taisto keulasta.<br><b>Jens Sjödén:</b> Vain 7 osallistujaa -> skrälliriski olematon.",
        "hevoset": [
    ...
    8: {
        ...
        "tyyppi": "dubbelklass",
        "vihje": "<b>Mats Djuse:</b> Todella avoin lähtö, varaa laajasti merkkejä. Ajokki 8 Uno omaa hyvän kapasiteetin.<br><b>Daniel Berglund:</b> Avoin lähtö, 8 Uno & 11 Bear Victor.<br><b>Jens Sjödén:</b> Paras skrällilähtö (40% skrällitoteutuma).",
        "hevoset": [
    ...
    9: {
        ...
        "matka": "2140m Autostart",
        "tyyppi": "2140a_sm",
        "vihje": "<b>Mats Djuse:</b> Ajokillani 1 Majblomster on kierroksen vahvimpia voittajaehdokkaita. Kovina haastajina 2 Prinsesse Ness Tjo ja 3 Tekno Tana.<br><b>Daniel Berglund:</b> 1 Majblomster johtaa alusta loppuun.<br><b>Jens Sjödén:</b> Tammakoitoissa ei skrällejä (Spika v V85-5).",
        "hevoset": [
    ...
    10: {
        ...
        "tyyppi": "tasaus",
        "vihje": "<b>Mats Djuse:</b> Ajokki 13 Rupie on hienossa kunnossa, mutta vaatii onnistumisen takamatkalta.<br><b>Daniel Berglund:</b> Vaikea lähtö. 6 Kopparmärra, 4 Grove's Maple Poof, 8 Brionne.<br><b>Jens Sjödén:</b> 2640m voltissa vahvat kirijät valttia.",
        "hevoset": [
    ...
    11: {
        ...
        "matka": "2140m Autostart",
        "tyyppi": "2140a_brons",
        "vihje": "<b>Mats Djuse:</b> Ajokillani 8 Lucky Silver on hyvää toivoa täynnä, mutta lähtöpaika on haastava.<br><b>Daniel Berglund:</b> 4 Mellby Mowgli, 3 Graces Bird, 10 Gosa Gosing.<br><b>Jens Sjödén:</b> Skrällää todella harvoin.",
        "hevoset": [
    ...
    12: {
        ...
        "matka": "2140m Autostart",
        "tyyppi": "2140a",
        "vihje": "<b>Mats Djuse:</b> Ajokillani 12 X.O.Kemp on huippukunnossa, mutta ulkorata tuo omat haasteensa juoksuun.<br><b>Daniel Berglund:</b> V85-päätös. Vahvat keulahevoset ja kirijät ratkaisevat.<br><b>Jens Sjödén:</b> Suosikit pitävät hyvin päätöskohteessa.",
        "hevoset": [
            ...
            {"numero": 6, "nimi": "Killer Rain", "ohjastaja": "Ohjastaja 6", "peruspaino": 0.7},
            {"numero": 7, "nimi": "Brilliant Kid", "ohjastaja": "Ohjastaja 7", "peruspaino": 0.5},
            {"numero": 8, "nimi": "Lähtö12 Hevonen 8", "ohjastaja": "Ohjastaja 8", "peruspaino": 0.4},
            {"numero": 9, "nimi": "Summermusic'nights", "ohjastaja": "Ohjastaja 9", "peruspaino": 0.8},
...
st.title("🏇 Hagmyren Ravioohjelma - Live Analysaattori (Lähdöt 1–12)")
