...
# ==============================================================================
# V85-YLLÄTTÄJÄANALYYSI & KIINTEÄT KERTOIMET (Lähdöt 5-12)
# ==============================================================================
...
st.caption("Työkalu hakee V85-kohteista (lähdöt 5–12) parhaat alle 10% pelatut yllättäjät huomioiden Unibetin kiinteät kertoimet, ruotsalaismedioiden vihjeet, lähtöpaikan, lähtötavan sekä perjantain ja lauantain peliprosenttien erot.")
...
st.divider()
st.subheader("💡 Peliohjeet")
st.markdown(
    """
    * **Yllättäjäkriteeri:** Taulukko suodattaa esiin vain ne V85-kohteiden hevoset (lähdöt 5–12), joiden lauantain peliprosentti on **alle 10%**, mutta simuloitu voittotodennäköisyys ja kiinteät kertoimet tarjoavat selvän ylikertoimen.
    * **Perjantai vs. Lauantai:** Muutos-sarake auttaa hahmottamaan yleisön pelikäyttäytymisen muutokset ennen starttia.
    * **Perustelut:** Huomioi lähtötavat (auto vs. voltti), lähtöpaikat sekä ruotsalaismedioiden (Travronden, Expressen, Aftonbladet) vihjeet.
    """
)
