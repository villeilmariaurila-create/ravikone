...
# ==============================================================================
# 1. HAGMYREN V85-DATAN ALUSTUS + DANIEL BERGLUNDIN VIHJEET & RADAN OMINAISUUDET
# ==============================================================================
...
DATABANK = {
    5: {
        ...
        "vihje": "<b>Daniel Berglund:</b> 9 Night Hawk on saanut kaksi lähtöä alle uudessa valmennuksessa ja kesti hyvin kovia vastaan viimeksi. Pysyy luokassaan ja kirii vahvasti kova tempoisessa juoksussa. 2 Hip To Be Square teki hyvän juoksun derbykarsinnassa ja kohtaa nyt helpomman vastuksen.",
        "hevoset": [
            {"numero": 1, "nimi": "T.Wall's Notorius", "ohjastaja": "Jomar Blekkan", "peli_pct": 12, "paino": 1.0},
            {"numero": 2, "nimi": "Hip To Be Square", "ohjastaja": "Per Lennartsson", "peli_pct": 32, "paino": 1.4},
            {"numero": 3, "nimi": "Sign Of Times", "ohjastaja": "Tomas Pettersson", "peli_pct": 8, "paino": 0.9},
            {"numero": 4, "nimi": "Geisha Road Grif", "ohjastaja": "Jorma Kontio", "peli_pct": 10, "paino": 1.0},
            {"numero": 5, "nimi": "Macho Cabrio B.B.", "ohjastaja": "Peter G Norman", "peli_pct": 11, "paino": 1.0},
            {"numero": 6, "nimi": "Henessi Kiev", "ohjastaja": "Oskar J Andersson", "peli_pct": 6, "paino": 0.8},
            {"numero": 7, "nimi": "Takter", "ohjastaja": "Hans G Eriksson", "peli_pct": 3, "paino": 0.6},
            {"numero": 8, "nimi": "Herkules A'lir", "ohjastaja": "Rikard N Skoglund", "peli_pct": 14, "paino": 1.2},
            {"numero": 9, "nimi": "Night Hawk", "ohjastaja": "Mats E Djuse", "peli_pct": 4, "paino": 1.25}, # Berglundin tärppi
            {"numero": 10, "nimi": "Huchuy Qosqo", "ohjastaja": "Anders Eriksson", "peli_pct": 2, "paino": 0.5},
            {"numero": 11, "nimi": "De Är Hon", "ohjastaja": "Ulf Ohlsson", "peli_pct": 1, "paino": 0.4},
            {"numero": 12, "nimi": "Sandsjöns Cantona", "ohjastaja": "Claes Sjöström", "peli_pct": 7, "paino": 0.8},
        ]
    },
    6: {
        ...
        "hevoset": [
            {"numero": 1, "nimi": "Fosshaug Frasse", "ohjastaja": "Michaela B Fransson", "peli_pct": 2, "paino": 0.6},
            {"numero": 2, "nimi": "Sangviks Lynet", "ohjastaja": "Ulf Ohlsson", "peli_pct": 10, "paino": 1.1},
            {"numero": 3, "nimi": "Andarnas Patron", "ohjastaja": "Rikard N Skoglund", "peli_pct": 5, "paino": 0.9},
            ...
            {"numero": 6, "nimi": "Guli Hektor", "ohjastaja": "Örjan Kihlström", "peli_pct": 4, "paino": 0.8},
            {"numero": 7, "nimi": "Tåga Ryker", "ohjastaja": "Ingvar Nyberg", "peli_pct": 2, "paino": 0.5},
            {"numero": 8, "nimi": "Teknologen", "ohjastaja": "Robert Skoglund", "peli_pct": 22, "paino": 1.5}, # Berglundin tärppi
            {"numero": 9, "nimi": "Ava Modde", "ohjastaja": "Henrik Svensson", "peli_pct": 3, "paino": 0.6},
            {"numero": 10, "nimi": "Re Alkapital", "ohjastaja": "Joakim Eskilsson", "peli_pct": 4, "paino": 0.6},
            {"numero": 11, "nimi": "Mira Kiro", "ohjastaja": "Jorma Kontio", "peli_pct": 6, "paino": 0.7},
            {"numero": 12, "nimi": "Ersa Frej", "ohjastaja": "Nathalie Blom", "peli_pct": 1, "paino": 0.3},
            {"numero": 13, "nimi": "Klack Vidar", "ohjastaja": "Magnus A Djuse", "peli_pct": 3, "paino": 0.4},
            {"numero": 14, "nimi": "Blixen", "ohjastaja": "Jan-Olof Johansson", "peli_pct": 2, "paino": 0.4},
            {"numero": 15, "nimi": "Guli Em", "ohjastaja": "Marcus Lilius", "peli_pct": 3, "paino": 0.4},
        ]
    },
    7: {
        ...
        "hevoset": [
            {"numero": 1, "nimi": "Before Takeoff", "ohjastaja": "Örjan Kihlström", "peli_pct": 22, "paino": 1.45}, # Keulaetulyönti (170m upplopp)
            {"numero": 2, "nimi": "Santos De Castella", "ohjastaja": "Marcus Lilius", "peli_pct": 5, "paino": 0.6},
            {"numero": 3, "nimi": "Romulus Tooma", "ohjastaja": "Peter G Norman", "peli_pct": 2, "paino": 0.4},
            {"numero": 4, "nimi": "Mizai", "ohjastaja": "Per Lennartsson", "peli_pct": 12, "paino": 1.0},
            {"numero": 5, "nimi": "Lando Mearas", "ohjastaja": "Magnus A Djuse", "peli_pct": 28, "paino": 1.25},
            {"numero": 6, "nimi": "Mellby Joker", "ohjastaja": "Mats E Djuse", "peli_pct": 21, "paino": 1.15},
            {"numero": 7, "nimi": "Jerka Sting", "ohjastaja": "Claes Sjöström", "peli_pct": 10, "paino": 0.85},
        ]
    },
    8: {
        ...
        "hevoset": [
            ...
            {"numero": 8, "nimi": "Uno", "ohjastaja": "Mats E Djuse", "peli_pct": 7, "paino": 1.1}, # Berglundin nosto
            ...
            {"numero": 11, "nimi": "Bear Victor", "ohjastaja": "Ulf Ohlsson", "peli_pct": 8, "paino": 1.25}, # Berglundin yllättäjätärppi
    ...
    9: {
        ...
        "hevoset": [
            {"numero": 1, "nimi": "Majblomster", "ohjastaja": "Mats E Djuse", "peli_pct": 48, "paino": 2.1}, # Vahva keulasuosikki
            ...
            {"numero": 4, "nimi": "Hulte Alva", "ohjastaja": "Linda S Hedström", "peli_pct": 7, "paino": 0.8},
            {"numero": 5, "nimi": "Guli Stina", "ohjastaja": "Ulf Ohlsson", "peli_pct": 3, "paino": 0.5},
            {"numero": 6, "nimi": "Hög Decibel", "ohjastaja": "Stig Jarle Röste", "peli_pct": 2, "paino": 0.4},
            {"numero": 7, "nimi": "Hulte Annika", "ohjastaja": "Magnus A Djuse", "peli_pct": 5, "paino": 0.7},
            {"numero": 8, "nimi": "Jonases Ninja", "ohjastaja": "Jan-Olov Åberg", "peli_pct": 3, "paino": 0.5},
            {"numero": 9, "nimi": "Eldida", "ohjastaja": "Ida Eriksson", "peli_pct": 1, "paino": 0.3},
            {"numero": 10, "nimi": "Rötungen", "ohjastaja": "Micael Melander", "peli_pct": 1, "paino": 0.3},
            {"numero": 11, "nimi": "Saga Kiro", "ohjastaja": "Per Lennartsson", "peli_pct": 2, "paino": 0.4},
            {"numero": 12, "nimi": "Ethel", "ohjastaja": "Henrik Svensson", "peli_pct": 2, "paino": 0.4},
        ]
    },
    10: {
        ...
        "hevoset": [
            ...
            {"numero": 4, "nimi": "Grove's Maple Poof", "ohjastaja": "Ulf Ohlsson", "peli_pct": 12, "paino": 1.25},
            {"numero": 5, "nimi": "Bohemian Maid", "ohjastaja": "Magnus A Djuse", "peli_pct": 18, "paino": 1.3},
            {"numero": 6, "nimi": "Kopparmärra", "ohjastaja": "Nathalie Blom", "peli_pct": 4, "paino": 0.9}, # Berglundin nosto juoksuradalta
            {"numero": 7, "nimi": "C'est Ma Course", "ohjastaja": "Lucas H Vikström", "peli_pct": 5, "paino": 0.8},
            {"numero": 8, "nimi": "Brionne", "ohjastaja": "Rikard N Skoglund", "peli_pct": 14, "paino": 1.25},
    ...
    11: {
        ...
        "matka": "2140m Autostart",
        "vihje": "<b>Daniel Berglund:</b> (Lopp 12 korvattu tässä kohteella 11). 10 Gosa Gosing oli hyvänä keulasta, mutta pussissa takarivistä. 4 Mellby Mowgli on voittanut helpompia ja on hieno keulasta. Tosin keulassa istunee 3 Graces Bird, joka kesti kovan prässin viimeksi.",
        "hevoset": [
            {"numero": 1, "nimi": "Bruce Braylon", "ohjastaja": "Per Lennartsson", "peli_pct": 16, "paino": 1.2},
            {"numero": 2, "nimi": "Pineapple", "ohjastaja": "Carl Johan Jepson", "peli_pct": 14, "paino": 1.1},
            {"numero": 3, "nimi": "Graces Bird", "ohjastaja": "Fredrik Plassen", "peli_pct": 6, "paino": 1.05}, # Keulaehdokas
            {"numero": 4, "nimi": "Mellby Mowgli", "ohjastaja": "Örjan Kihlström", "peli_pct": 22, "paino": 1.4},
            {"numero": 5, "nimi": "Ebbot Rice", "ohjastaja": "Linus Lönn", "peli_pct": 4, "paino": 0.7},
            {"numero": 6, "nimi": "Jaguar Godiva", "ohjastaja": "Ulf Ohlsson", "peli_pct": 10, "paino": 1.0},
            {"numero": 7, "nimi": "Don E.Star", "ohjastaja": "Oskar J Andersson", "peli_pct": 2, "paino": 0.5},
            {"numero": 8, "nimi": "Lucky Silver", "ohjastaja": "Mats E Djuse", "peli_pct": 12, "paino": 1.0},
            {"numero": 9, "nimi": "Elvis T.C.B.", "ohjastaja": "Marcus Lilius", "peli_pct": 5, "paino": 0.8},
            {"numero": 10, "nimi": "Gosa Gosing", "ohjastaja": "Rikard N Skoglund", "peli_pct": 5, "paino": 0.85}, # Takarivin haaste
            {"numero": 11, "nimi": "Punchboard", "ohjastaja": "Magnus A Djuse", "peli_pct": 3, "paino": 0.6},
            {"numero": 12, "nimi": "Slivovitz Lover", "ohjastaja": "Claes Sjöström", "peli_pct": 1, "paino": 0.4},
        ]
    }
}
...
st.set_page_config(page_title="Hagmyren Ravisimulaattori & Berglund Analysis", layout="wide")

st.title("🏇 Hagmyren - Mallinnus & Daniel Berglund Vihjeet")
st.caption("Monte Carlo -simulaatio + Asiantuntija-analyysi vs. Markkinan peliprosentit")

# Ratalaitatiedot info-laatikossa
with st.expander("ℹ️ **Huomioi Hagmyrenin ratalaitatiedot & Jackpot**"):
    st.markdown("""
    * **Lyhyt loppusuora (170 metriä):** Erittäin edullista ajaa kärjessä tai keulapaikalla.
    * **Autolähtö:** Korta suorat tekevät sisimmistä radoista (erityisesti rata 1) haastavan kiihdytyksessä.
    * **Jackpot:** V85-poolissa on yli **15,3 miljoonaa SEK extraa**!
    """)
